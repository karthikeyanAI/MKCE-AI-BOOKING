...
exports.ListAccessPointsForObjectLambdaCommand = exports.$Command = void 0;
...
class ListAccessPointsForObjectLambdaCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ListAccessPointsForObjectLambdaCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restXml_1.se_ListAccessPointsForObjectLambdaCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restXml_1.de_ListAccessPointsForObjectLambdaCommand)(output, context);
    }
}
