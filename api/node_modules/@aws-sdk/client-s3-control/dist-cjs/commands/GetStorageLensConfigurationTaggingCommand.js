...
class GetStorageLensConfigurationTaggingCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetStorageLensConfigurationTaggingCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restXml_1.se_GetStorageLensConfigurationTaggingCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restXml_1.de_GetStorageLensConfigurationTaggingCommand)(output, context);
    }
}
