...
exports.GetAccessPointPolicyForObjectLambdaCommand = exports.$Command = void 0;
...
class GetAccessPointPolicyForObjectLambdaCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetAccessPointPolicyForObjectLambdaCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restXml_1.se_GetAccessPointPolicyForObjectLambdaCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restXml_1.de_GetAccessPointPolicyForObjectLambdaCommand)(output, context);
    }
}
