...
exports.ListStorageLensConfigurationsCommand = exports.$Command = void 0;
...
class ListStorageLensConfigurationsCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, ListStorageLensConfigurationsCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restXml_1.se_ListStorageLensConfigurationsCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restXml_1.de_ListStorageLensConfigurationsCommand)(output, context);
    }
}
