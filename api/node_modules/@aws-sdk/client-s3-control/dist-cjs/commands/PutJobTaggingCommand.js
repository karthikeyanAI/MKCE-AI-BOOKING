...
exports.PutJobTaggingCommand = exports.$Command = void 0;
...
class PutJobTaggingCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, PutJobTaggingCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restXml_1.se_PutJobTaggingCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restXml_1.de_PutJobTaggingCommand)(output, context);
    }
}
