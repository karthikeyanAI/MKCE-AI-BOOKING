...
class GetMultiRegionAccessPointPolicyStatusCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        this.middlewareStack.use((0, middleware_endpoint_1.getEndpointPlugin)(configuration, GetMultiRegionAccessPointPolicyStatusCommand.getEndpointParameterInstructions()));
    ...
    serialize(input, context) {
        return (0, Aws_restXml_1.se_GetMultiRegionAccessPointPolicyStatusCommand)(input, context);
    }
    deserialize(output, context) {
        return (0, Aws_restXml_1.de_GetMultiRegionAccessPointPolicyStatusCommand)(output, context);
    }
}
